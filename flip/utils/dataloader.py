"""
This script defines a custom PyTorch Dataset class for protein sequences and 
provides functionality to create a DataLoader for the dataset.

Classes:
    ProteinDataset: A custom Dataset class for protein sequences.
    custom_collate_fn: A custom collate function to handle variable-length sequences in a batch.
    create_dataloader: A function to create a DataLoader for the ProteinDataset.
"""

import torch
from torch.utils.data import Dataset, DataLoader
from flip.utils.sequence_database import SequenceDatabase
